...
export default function EducationPage() {
  const initiatives = [
    "Providing essential learning materials such as stationery, books, and school supplies to students in need",
    "Supporting school fee payments for children from financially constrained backgrounds",
    "Offering scholarships to deserving and committed students",
    "Creating awareness about the importance of education, especially in communities with limited access",
  ];
    ...
    <div className="bg-white">
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-section text-gray-900 mb-8">Our Education Program</h2>
      ...
      <section className="bg-[#5a7a96] text-white section-padding">
        <div className="section-container text-center">
          <h2 className="heading-md text-white mb-6">Support Our Education Mission</h2>
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-white/90 max-w-3xl mx-auto">
            Your donation can help us provide quality education to children who need it most.
          </p>
