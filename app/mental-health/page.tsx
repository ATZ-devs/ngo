...
export default function MentalHealthPage() {
  const initiatives = [
    "Creating awareness around mental health and related issues",
    "Connecting individuals with access to therapy and support where possible",
    "Supporting people facing severe mental health challenges",
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-[400px] flex items-center overflow-hidden">
        <Image
          src="/assets/Mental Health Awareness.png"
          alt="Mental Health Awareness Initiative"
          fill
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-section text-gray-900 mb-8">Our Mental Health Program</h2>
      ...
      <section className="bg-[#5a7a96] text-white section-padding">
        <div className="section-container text-center">
          <h2 className="heading-md text-white mb-6">Support Our Mental Health Mission</h2>
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-white/90 max-w-3xl mx-auto">
            Your donation can help us support mental health awareness and care.
          </p>
