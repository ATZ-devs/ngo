...
export default function WomenEmpowermentPage() {
  const initiatives = [
    "Spreading awareness in rural areas about the importance of girls' education",
    "Creating awareness about women's issues within communities",
    "Promoting legal awareness so women understand their rights and available remedies",
    "Supporting women with basic sanitation and hygiene needs",
    "Engaging with women in communities to discuss health, education, and everyday challenges",
    "Supporting widows through basic assistance and community support",
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-[400px] flex items-center overflow-hidden">
        <Image
          src="/assets/Women Development.png"
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-section text-gray-900 mb-8">Our Women Empowerment Program</h2>
