...
export default function SkillDevelopmentPage() {
  const initiatives = [
    "Teaching skills such as tailoring, basic computer use, and handicraft work to individuals from underprivileged backgrounds",
    "Providing vocational training for youth to help them find employment",
    "Focusing on practical, hands-on learning so skills can be directly used for earning",
    "Encouraging small-scale income activities based on the skills learned",
  ];
    ...
    <div className="bg-white">
      ...
      <section className="section-padding">
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-section text-gray-900 mb-8">Our Skill Development Program</h2>
      ...
      <section className="bg-[#5a7a96] text-white section-padding">
        <div className="section-container text-center">
          <h2 className="heading-md text-white mb-6">Support Our Skill Development Mission</h2>
